	...
	public:
		...
		Shader(const char* vertexPath, const char* fragmentPath){
			...
			try{
				...
				//assigning the streams read to the strings we created
			...
			const char* vShaderCode = vertexCode.c_str(); // c_str() returns a pointer to null terminated character array of string 
